# Concurrency - A generic, reusable Go module for concurrency primitives: worker pools, priority queues, rate limiters, circuit breakers, semaphores, and resource monitoring.
# Module: digital.vasic.concurrency
...
challenge:
	../challenges/scripts/concurrency_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Concurrency - A generic, reusable Go module for concurrency primitives: worker pools, priority queues, rate limiters, circuit breakers, semaphores, and resource monitoring."
	@echo ""
	@echo "Build & Test:"
