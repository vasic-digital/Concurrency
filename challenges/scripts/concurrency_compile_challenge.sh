#!/usr/bin/env bash
# concurrency_compile_challenge.sh - Validates Concurrency module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.concurrency"
if grep -q "^module digital.vasic.concurrency$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.concurrency"
else
...
# Test 8: All 6 packages compile independently
